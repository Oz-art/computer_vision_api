...
# Import Class Model
from app_object_detection.models import Detector
...
def object_detection_api(request):
    ...
    if request.method == 'POST':
        ...
        mode_deteksi = int(data_form.get('mode'))
        ...
        if mode_deteksi == 1:
            ...
            image_result, boxes, names = detect_object_v2(image)
        # -----------------------------------------------
...
def detect_object_v2(image):
    frame_output, boxes, names = Detector.det.detect(image)
